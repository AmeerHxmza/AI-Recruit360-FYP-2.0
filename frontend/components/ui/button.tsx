...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-micro focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#39D9FF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#08090B] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
          "bg-[#39D9FF] text-[#08090B] hover:bg-[#63E3FF] active:bg-[#39D9FF] font-medium shadow-sm",
        secondary:
          "bg-[#171B21] text-[#F5F7FA] border border-[#242932] hover:bg-[#242932] active:bg-[#171B21]",
        outline:
          "bg-transparent text-[#F5F7FA] border border-[#242932] hover:bg-[#12151A] hover:border-[#39D9FF]/40",
        ghost:
          "bg-transparent text-[#A7AFBC] hover:text-[#F5F7FA] hover:bg-[#171B21]",
        danger:
          "bg-[#FF5C67]/10 text-[#FF5C67] border border-[#FF5C67]/30 hover:bg-[#FF5C67]/20",
        ai:
          "bg-gradient-to-r from-[#39D9FF] to-[#63E3FF] text-[#08090B] font-semibold shadow-[0_0_16px_rgba(57,217,255,0.25)] hover:shadow-[0_0_20px_rgba(99,227,255,0.4)] hover:opacity-95",
